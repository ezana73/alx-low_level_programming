...
/**
 * iterate_zeroes -iterate through a string number contianing
 * loading zeroes until hits non zero number
 * @str: string numbers to be iterates through
 *
 ...
 * @c: characterto be converted
 *
 * Description: if c is non digit,the function exit status 98
